...
| TC-02 | Đăng nhập thất bại — sai mật khẩu (*Wrong password*) | `test_login.py`         | ✅ Đã xong  |
| TC-03 | Đăng nhập thất bại — để trống (*Empty fields*)       | `test_login.py`         | ✅ Đã xong  |
| TC-04 | Tìm sách theo tên (*Search by name*)                 | `test_search.py`        | ✅ Đã xong  |
| TC-05 | Tìm sách — không có kết quả (*No result*)            | `test_search.py`        | ✅ Đã xong  |
| TC-06 | Lọc theo thể loại (*Filter by category*)             | `test_search.py`        | ✅ Đã xong  |
| TC-07 | Tìm theo tác giả (*Search by author*)                | `test_search.py`        | ✅ Đã xong  |
| TC-08 | Mượn sách (*Borrow a book*)                          | `test_borrow_return.py` | ✅ Đã xong  |
| TC-09 | Xem sách đang mượn (*View borrowed books*)           | `test_borrow_return.py` | ✅ Đã xong  |
| TC-10 | Trả sách (*Return a book*)                           | `test_borrow_return.py` | ✅ Đã xong  |
| TC-11 | Đăng xuất (*Logout*)                                 | `test_general.py`       | ✅ Đã xong  |
| TC-12 | Chuyển ngôn ngữ sang EN (*Switch language*)          | `test_general.py`       | ✅ Đã xong  |
